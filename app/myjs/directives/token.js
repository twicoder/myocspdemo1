angular.module('myApp').directive('tokenfield', ['strService', '$filter', function (strService, $filter) {
  return {
    restrict: 'E',
    ...
    controller: function ($scope) {
      ...
      $scope.inputChanged = function () {
        if (!!$scope.checkinputfield && $scope.checkinputfield === 'true') {
          var invalidOuptuFields = [];
          if (!!$scope.ngModel) {
            var outputFields = $scope.ngModel.split(',');
            outputFields.forEach(function(item){
