ocspspace.ContextMenu = (function () {
  ...
  var isConfigurable = function (selection) {
    ...
    var isConfigurableComponent = ocspspace.CanvasUtils.isLabel(selection) || ocspspace.CanvasUtils.isProcessGroup(selection);
    if (!isConfigurableComponent) {
      if (ocspspace.CanvasUtils.isProcessor(selection) || ocspspace.CanvasUtils.isInputPort(selection) || ocspspace.CanvasUtils.isOutputPort(selection) || ocspspace.CanvasUtils.isRemoteProcessGroup(selection) || ocspspace.CanvasUtils.isConnection(selection)) {
        isConfigurableComponent = ocspspace.CanvasUtils.supportsModification(selection);
      }
    }

    return isConfigurableComponent; // && ocspspace.Common.isDFM();
  };
  ...
  var isDeletable = function (selection) {
    return ocspspace.Common.isDFM() && ocspspace.CanvasUtils.isDeletable(selection);
  };
  ...
  var isRunnable = function (selection) {
    return ocspspace.Common.isDFM() && ocspspace.CanvasUtils.areRunnable(selection);
  };
  ...
  var isStoppable = function (selection) {
    return ocspspace.Common.isDFM() && ocspspace.CanvasUtils.areStoppable(selection);
  };
  ...
  var supportsStats = function (selection) {
    ...
    return ocspspace.CanvasUtils.isProcessor(selection) || ocspspace.CanvasUtils.isProcessGroup(selection) || ocspspace.CanvasUtils.isRemoteProcessGroup(selection) || ocspspace.CanvasUtils.isConnection(selection);
  };
  ...
  var hasUsage = function (selection) {
    ...
    return ocspspace.CanvasUtils.isProcessor(selection);
  };
  ...
  var isNotConnection = function (selection) {
    return selection.size() === 1 && !ocspspace.CanvasUtils.isConnection(selection);
  };
  ...
  var isCopyable = function (selection) {
    return ocspspace.Common.isDFM() && ocspspace.CanvasUtils.isCopyable(selection);
  };
  ...
  var isPastable = function (selection) {
    return ocspspace.Common.isDFM() && ocspspace.CanvasUtils.isPastable();
  };
  ...
  var canMoveToFront = function (selection) {
    ...
    return ocspspace.Common.isDFM() && ocspspace.CanvasUtils.isConnection(selection);
  };
  ...
  var isColorable = function (selection) {
    ...
    return ocspspace.Common.isDFM() && (ocspspace.CanvasUtils.isProcessor(selection) || ocspspace.CanvasUtils.isLabel(selection));
  };
  ...
  var isConnection = function (selection) {
    ...
    return ocspspace.CanvasUtils.isConnection(selection);
  };
  ...
  var hasDownstream = function (selection) {
    ...
    return ocspspace.CanvasUtils.isFunnel(selection) || ocspspace.CanvasUtils.isProcessor(selection) || ocspspace.CanvasUtils.isProcessGroup(selection) ||
      ocspspace.CanvasUtils.isRemoteProcessGroup(selection) || ocspspace.CanvasUtils.isInputPort(selection) ||
      (ocspspace.CanvasUtils.isOutputPort(selection) && ocspspace.Canvas.getParentGroupId() !== null);
  };
  ...
  var hasUpstream = function (selection) {
    ...
    return ocspspace.CanvasUtils.isFunnel(selection) || ocspspace.CanvasUtils.isProcessor(selection) || ocspspace.CanvasUtils.isProcessGroup(selection) ||
      ocspspace.CanvasUtils.isRemoteProcessGroup(selection) || ocspspace.CanvasUtils.isOutputPort(selection) ||
      (ocspspace.CanvasUtils.isInputPort(selection) && ocspspace.Canvas.getParentGroupId() !== null);
  };
  ...
  var isProcessGroup = function (selection) {
    ...
    return ocspspace.CanvasUtils.isProcessGroup(selection);
  };
  ...
  var isRemoteProcessGroup = function (selection) {
    ...
    return ocspspace.CanvasUtils.isRemoteProcessGroup(selection);
  };
  ...
  var canStartTransmission = function (selection) {
    return ocspspace.Common.isDFM() && ocspspace.CanvasUtils.canAllStartTransmitting(selection);
  };
  ...
  var canStopTransmission = function (selection) {
    return ocspspace.Common.isDFM() && ocspspace.CanvasUtils.canAllStopTransmitting(selection);
  };
  ...
  var executeAction = function (action, selection, evt) {
    // execute the action
    ocspspace.Actions[action](selection, evt);
